...
• It is a project built upon Ultralytics’ open-source code. <br>
• Unauthorized sales or any actions that violate Ultralytics’ terms of use are strictly prohibited. This library fully complies with Ultralytics’ license and terms of use. <br>
• In WSL (Windows Subsystem for Linux) environments, the DALI library cannot achieve its full performance. <br>
